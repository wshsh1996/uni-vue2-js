...
import SpList from '@/pages/index/components/spList.vue'
import { getRect } from '@/utils/lib'
import { ApiCustomerList } from '@/api/user'
...
export default {
  ...
  methods: {
    ...
    upCallback(page) {
      ...
      let member = this.tabIndex === 0 ? '' : this.tabIndex === 1 ? 1 : 0

      ApiCustomerList(this.page, this.pageSize, member, '').then((res) => {
